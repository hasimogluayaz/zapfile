  ...
  },
  {
    ...
    emojis: [
      ...
      },
      {
        emoji: "🙌",
        name: "raising hands",
        keywords: ["celebrate", "raise", "hooray"],
      },
      ...
      { emoji: "🧝", name: "elf", keywords: ["elf", "fantasy"] },
      {
        emoji: "🧜",
        name: "merperson",
        keywords: ["mermaid", "merman", "fantasy"],
      },
  ...
  },
  {
    ...
    emojis: [
      ...
      { emoji: "🏎️", name: "racing car", keywords: ["race", "fast", "speed"] },
      {
        emoji: "🚑",
        name: "ambulance",
        keywords: ["ambulance", "emergency", "hospital"],
      },
      ...
      { emoji: "🗺️", name: "world map", keywords: ["map", "world", "travel"] },
      {
        emoji: "🧭",
        name: "compass",
        keywords: ["compass", "navigate", "direction"],
      },
      {
        emoji: "🏔️",
      ...
      },
      {
        ...
        keywords: ["castle", "medieval", "europe"],
      },
      {
        emoji: "🕌",
        name: "mosque",
        keywords: ["mosque", "islam", "religion"],
      },
      {
        emoji: "⛪",
        name: "church",
        keywords: ["church", "religion", "cross"],
      },
      {
        emoji: "🕍",
        name: "synagogue",
      ...
      },
      {
        ...
        keywords: ["castle", "japanese", "japan"],
      },
      {
        emoji: "🌋",
        name: "volcano",
        keywords: ["volcano", "eruption", "lava"],
      },
      {
        emoji: "🏝️",
        name: "desert island",
        keywords: ["island", "palm", "tropical"],
      },
      {
        emoji: "🛫",
        name: "airplane departure",
        keywords: ["depart", "fly", "plane"],
      },
      {
        emoji: "🛬",
        name: "airplane arrival",
        keywords: ["arrive", "fly", "plane"],
      },
      {
        emoji: "🎡",
        name: "ferris wheel",
        keywords: ["ferris wheel", "fair", "amusement"],
      },
      {
        emoji: "🎢",
        name: "roller coaster",
  ...
  },
  {
    ...
    emojis: [
      ...
      },
      {
        emoji: "☎️",
        name: "telephone",
        keywords: ["phone", "call", "landline"],
      },
      { emoji: "📷", name: "camera", keywords: ["camera", "photo", "picture"] },
      {
        emoji: "🎥",
        name: "movie camera",
        keywords: ["camera", "film", "video"],
      },
      {
        emoji: "📺",
        name: "television",
      ...
      { emoji: "💊", name: "pill", keywords: ["pill", "medicine", "drug"] },
      {
        emoji: "🩺",
        name: "stethoscope",
        keywords: ["stethoscope", "doctor", "medicine"],
      },
      {
        emoji: "🧪",
        name: "test tube",
      ...
      { emoji: "🥁", name: "drum", keywords: ["drum", "music", "percussion"] },
      {
        emoji: "🎺",
        name: "trumpet",
        keywords: ["trumpet", "music", "instrument"],
      },
      {
        emoji: "🎻",
        name: "violin",
        keywords: ["violin", "music", "instrument"],
      },
      {
        emoji: "🎙️",
        name: "studio microphone",
        keywords: ["microphone", "podcast", "record"],
      },
    ],
  },
  {
    ...
    emojis: [
      ...
      { emoji: "💫", name: "dizzy", keywords: ["dizzy", "star", "sparkle"] },
      {
        emoji: "⚡",
        name: "high voltage",
        keywords: ["lightning", "electricity", "fast"],
      },
      ...
      },
      {
        emoji: "🏆",
        name: "trophy",
        keywords: ["trophy", "award", "win", "first"],
      },
      {
        emoji: "🥇",
        name: "first place medal",
        keywords: ["gold", "first", "win"],
      },
      ...
      },
      {
        emoji: "❓",
        name: "question mark",
        keywords: ["question", "what", "ask"],
      },
      {
        emoji: "❗",
        name: "exclamation mark",
        keywords: ["exclamation", "important"],
      },
      {
        emoji: "♻️",
        name: "recycling symbol",
        keywords: ["recycle", "green", "eco"],
      },
      ...
      },
      {
        emoji: "🌀",
        name: "cyclone",
        keywords: ["cyclone", "hurricane", "spin"],
      },
  ...
  },
  {
    ...
    emojis: [
      ...
      { emoji: "🏴", name: "black flag", keywords: ["black flag"] },
      {
        ...
        keywords: ["flag", "red", "mark"],
      },
      {
        emoji: "🏁",
        name: "chequered flag",
        keywords: ["race", "finish", "flag"],
      },
      {
        emoji: "🏴‍☠️",
        name: "pirate flag",
      ...
      },
      {
        ...
        keywords: ["korea", "south korea", "flag"],
      },
      {
        emoji: "🇮🇹",
        name: "flag: Italy",
      ...
      { emoji: "🇸🇬", name: "flag: Singapore", keywords: ["singapore", "flag"] },
      {
        ...
        keywords: ["new zealand", "kiwi", "flag"],
      },
      {
        emoji: "🇨🇭",
      ...
      },
      {
        emoji: "🇺🇦",
        name: "flag: Ukraine",
        keywords: ["ukraine", "ukrainian", "flag"],
      },
    ],
  },
];
...
export default function EmojiPickerPage() {
  ...
  useEffect(() => {
    try {
      const stored = localStorage.getItem("zapfile-emoji-recents");
  ...
  const saveRecents = useCallback((list: string[]) => {
    setRecents(list);
    try {
      localStorage.setItem("zapfile-emoji-recents", JSON.stringify(list));
    } catch {
      /* ignore */
    }
  }, []);
  ...
  const totalCount = filteredEmojis.reduce(
  ...
  const copyEmoji = async (emoji: string) => {
    try {
      ...
      toast.success(`Copied: ${emoji}`, { duration: 3000 });
      // Add to recents
      saveRecents([emoji, ...recents.filter((e) => e !== emoji)].slice(0, 24));
    } catch {
          ...
          <div className="glass rounded-xl p-4">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-sm font-semibold text-t-secondary">
                {t("emoji.recent")}
                <span className="ml-2 text-xs text-t-tertiary font-normal">
                  ({recents.length})
                </span>
              </h3>
              <button
                ...
                className="text-[11px] text-t-tertiary hover:text-t-primary transition-colors px-2 py-1 rounded-lg hover:bg-bg-secondary"
              >
                {t("ui.clear")}
              </button>
            </div>
            ...
            {categories.map((cat) => {
              const count =
                cat === "All"
                  ...
                  : (EMOJI_DATA.find((c) => c.name === cat)?.emojis.length ??
                    0);
              return (
                <button
                  key={cat}
