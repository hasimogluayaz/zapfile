    ...
    >
      <div className="space-y-6">
        ...
        <div
          ...
          onClick={generateNew}
          title={locked ? "Unlock to generate" : "Click to generate new color"}
        >
          <div
          ...
          >
            ...
            <span className="text-sm opacity-60">
              {locked ? "🔒 Locked" : "Click or press Space"}
            </span>
          </div>
        </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-medium text-t-primary">
                Best text color: <span className="font-mono">{textColor}</span>
              </div>
              <div className="text-xs text-t-tertiary">Based on WCAG luminance contrast ratio</div>
            </div>
          </div>
        </div>
        ...
        <div className="glass rounded-xl p-6">
          <h3 className="text-sm font-semibold text-t-secondary mb-4">Color Values</h3>
