...
const en: Record<string, string> = {
    ...
    "meme.undo": "Undo",
    "meme.redo": "Redo",
    "meme.dropLabel": "Drop your image here to start making memes",
    "meme.templates": "Meme Templates",
    "meme.templatesHint": "Upload an image first, then apply a template to quickly set up text layers.",
    "meme.preview": "Preview",
    "meme.addText": "+ Add Text",
    "meme.newImage": "New Image",
    "meme.quickTemplates": "Quick Templates",
    "meme.downloadMeme": "Download Meme",
    "meme.textLayers": "Text Layers",
    "meme.addLayer": "+ Add",
    "meme.emptyText": "(empty)",
    "meme.deleteLayerTitle": "Delete layer",
    "meme.textLabel": "Text",
    "meme.enterText": "Enter text...",
    "meme.fontFamily": "Font Family",
    "meme.rotation": "Rotation",
    "meme.editSelected": "Edit Selected",
    "meme.alignment": "Alignment",
    "meme.deleteThisLayer": "Delete This Layer",
    "meme.selectHint": "Click a text layer above or click text on the preview to edit it.",
    "meme.preset.classic": "Classic Top/Bottom",
    "meme.preset.bottomCaption": "Bottom Caption",
    "meme.preset.reaction": "Reaction",
    "meme.preset.distractedBoyfriend": "Distracted Boyfriend",
...
const translations: Record<Locale, Record<string, string>> = {
  ...
  tr: {
    ...
    "meme.undo": "Geri Al",
    "meme.redo": "Yeniden Yap",
    "meme.dropLabel": "Meme oluşturmak için resminizi buraya bırakın",
    "meme.templates": "Meme Şablonları",
    "meme.templatesHint": "Önce bir resim yükleyin, ardından metin katmanlarını hızlıca ayarlamak için şablon seçin.",
    "meme.preview": "Önizleme",
    "meme.addText": "+ Metin Ekle",
    "meme.newImage": "Yeni Resim",
    "meme.quickTemplates": "Hızlı Şablonlar",
    "meme.downloadMeme": "Meme İndir",
    "meme.textLayers": "Metin Katmanları",
    "meme.addLayer": "+ Ekle",
    "meme.emptyText": "(boş)",
    "meme.deleteLayerTitle": "Katmanı sil",
    "meme.textLabel": "Metin",
    "meme.enterText": "Metin girin...",
    "meme.fontFamily": "Yazı Tipi",
    "meme.rotation": "Döndürme",
    "meme.editSelected": "Seçileni Düzenle",
    "meme.alignment": "Hizalama",
    "meme.deleteThisLayer": "Bu Katmanı Sil",
    "meme.selectHint": "Yukarıdan bir metin katmanı seçin veya önizlemede metne tıklayın.",
    "meme.preset.classic": "Klasik Üst/Alt",
    "meme.preset.bottomCaption": "Alt Başlık",
    "meme.preset.reaction": "Tepki",
    "meme.preset.distractedBoyfriend": "Dalgın Erkek Arkadaş",
  ...
  de: {
    ...
    "meme.undo": "Rückgängig",
    "meme.redo": "Wiederholen",
    "meme.dropLabel": "Bild hier ablegen, um Memes zu erstellen",
    "meme.templates": "Meme-Vorlagen",
    "meme.templatesHint": "Lade zuerst ein Bild hoch, dann wähle eine Vorlage für Textebenen.",
    "meme.preview": "Vorschau",
    "meme.addText": "+ Text hinzufügen",
    "meme.newImage": "Neues Bild",
    "meme.quickTemplates": "Schnellvorlagen",
    "meme.downloadMeme": "Meme herunterladen",
    "meme.textLayers": "Textebenen",
    "meme.addLayer": "+ Hinzufügen",
    "meme.emptyText": "(leer)",
    "meme.deleteLayerTitle": "Ebene löschen",
    "meme.textLabel": "Text",
    "meme.enterText": "Text eingeben...",
    "meme.fontFamily": "Schriftart",
    "meme.rotation": "Drehung",
    "meme.editSelected": "Auswahl bearbeiten",
    "meme.alignment": "Ausrichtung",
    "meme.deleteThisLayer": "Diese Ebene löschen",
    "meme.selectHint": "Klicke oben auf eine Textebene oder auf Text in der Vorschau.",
    "meme.preset.classic": "Klassisch Oben/Unten",
    "meme.preset.bottomCaption": "Untertitel unten",
    "meme.preset.reaction": "Reaktion",
    "meme.preset.distractedBoyfriend": "Abgelenkter Freund",
  ...
  fr: {
    ...
    "meme.undo": "Annuler",
    "meme.redo": "Rétablir",
    "meme.dropLabel": "Déposez votre image ici pour créer des mèmes",
    "meme.templates": "Modèles de mème",
    "meme.templatesHint": "Uploadez d'abord une image, puis choisissez un modèle pour les calques de texte.",
    "meme.preview": "Aperçu",
    "meme.addText": "+ Ajouter du texte",
    "meme.newImage": "Nouvelle image",
    "meme.quickTemplates": "Modèles rapides",
    "meme.downloadMeme": "Télécharger le mème",
    "meme.textLayers": "Calques de texte",
    "meme.addLayer": "+ Ajouter",
    "meme.emptyText": "(vide)",
    "meme.deleteLayerTitle": "Supprimer le calque",
    "meme.textLabel": "Texte",
    "meme.enterText": "Entrez du texte...",
    "meme.fontFamily": "Police",
    "meme.rotation": "Rotation",
    "meme.editSelected": "Modifier la sélection",
    "meme.alignment": "Alignement",
    "meme.deleteThisLayer": "Supprimer ce calque",
    "meme.selectHint": "Cliquez sur un calque ci-dessus ou sur le texte dans l'aperçu.",
    "meme.preset.classic": "Classique Haut/Bas",
    "meme.preset.bottomCaption": "Légende en bas",
    "meme.preset.reaction": "Réaction",
    "meme.preset.distractedBoyfriend": "Petit ami distrait",
